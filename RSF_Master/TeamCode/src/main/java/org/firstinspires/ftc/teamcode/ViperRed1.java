...
@TeleOp(name="ViperRed1", group="Pushbot")
public class ViperRed1 extends BaseOp{
    ...
    public void loop() {
        ...
        switch (step)
        {
            ...
            case 5: //move backward for 1.2 secs
                ...
                break;
            case 6: //rotate clockwise for 3.5 secs
                if (time < timeOffSet + 3.5d)
                {
...
//                _ArmMotor.getMotor().setTargetPosition(0);
                ...
                break;
            case 8: //move forward for 2.5 seconds
                if (time < timeOffSet + 2.5d)
                {
            ...
            //
            //moving forward
            case 13: //move forward for .5 seconds
                if (time < timeOffSet + 0.5d)
                {
                    _driveModule.move(1.0d, 1.0d);
                }
            ...
            case 14: //lift color arm for 2 secs
                ...
                break;
            case 15: //move forward for 2.0 second
                if (time < timeOffSet + 2.0d)
                {
                    _driveModule.setMaxPower(1.0d);
                    _driveModule.move(0.6d, 1.0d);
                }
                else
                {
                    _driveModule.move(0.0d, 0.0d);
